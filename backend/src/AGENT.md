...
**Last Updated:** 2026-03-06 03:56:12
**Folder Path:** `/home/user/GhostGoat/backend/src`
**Agent ID:** `pending`
...
context = system.backend.get_folder_context('/home/user/GhostGoat/backend/src')
```
