...
| Field | Value |
|---|---|
| **Folder** | `core/brain/memory/rag/agentic_rag_mcp` |
| **Agent ID** | `70781254` |
| **Last Updated** | `2026-04-30 03:38:56` |
| **Files Tracked** | `4` |
| **Total Size** | `16.1 KB` |
