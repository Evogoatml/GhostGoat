...
# dual_brain initialized at startup, not at module load
#
...
class RussellSetRunner(ParadoxRunner):
    ...
    def run(self) -> Dict[str, Any]:
        ...
        @property
        def definition(self):
            return "non_compliant_code_set_definition"
...
def main():
    ...
    # Save results
    import json
    output_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'paradox_analysis_results.json')
