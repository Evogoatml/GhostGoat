...
| Field | Value |
|---|---|
| **Folder** | `core/memory/rag/controlflow/src/controlflow/cli` |
| **Agent ID** | `cef8a880` |
...
- **`dev.py`** — 2.8 KB, modified 2026-04-23
- **`main.py`** — 1.2 KB, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/memory/rag/controlflow/src/controlflow/cli")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("cef8a880")
```
