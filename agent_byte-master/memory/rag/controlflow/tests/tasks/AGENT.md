...
| Field | Value |
|---|---|
| **Folder** | `core/memory/rag/controlflow/tests/tasks` |
| **Agent ID** | `d1d83e9a` |
...
- **`test_tasks.py`** — 19.8 KB, modified 2026-04-23
- **`test_validators.py`** — 2.0 KB, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/memory/rag/controlflow/tests/tasks")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("d1d83e9a")
```
