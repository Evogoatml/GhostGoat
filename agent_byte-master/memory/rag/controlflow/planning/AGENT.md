...
| Field | Value |
|---|---|
| **Folder** | `core/memory/rag/controlflow/src/controlflow/planning` |
| **Agent ID** | `d528e7d4` |
...
- **`__init__.py`** — 19 B, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/memory/rag/controlflow/src/controlflow/planning")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("d528e7d4")
```
