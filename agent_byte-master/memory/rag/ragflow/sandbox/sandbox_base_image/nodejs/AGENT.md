...
| Field | Value |
|---|---|
| **Folder** | `core/memory/rag/ragflow/sandbox/sandbox_base_image/nodejs` |
| **Agent ID** | `00f19674` |
...
- **`package.json`** — 267 B, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/memory/rag/ragflow/sandbox/sandbox_base_image/nodejs")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("00f19674")
```
