...
| Field | Value |
|---|---|
| **Folder** | `core/memory/rag/ragflow/sandbox/executor_manager/api` |
| **Agent ID** | `bdbe243b` |
...
- **`handlers.py`** — 2.1 KB, modified 2026-04-23
- **`routes.py`** — 814 B, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/memory/rag/ragflow/sandbox/executor_manager/api")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("bdbe243b")
```
