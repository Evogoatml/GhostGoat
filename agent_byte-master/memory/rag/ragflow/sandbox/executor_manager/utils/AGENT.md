...
| Field | Value |
|---|---|
| **Folder** | `core/memory/rag/ragflow/sandbox/executor_manager/utils` |
| **Agent ID** | `bb20a5f6` |
| **Last Updated** | `2026-04-30 03:40:11` |
| **Files Tracked** | `2` |
| **Total Size** | `2.0 KB` |
...
- **`common.py`** — 1.4 KB, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/memory/rag/ragflow/sandbox/executor_manager/utils")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("bb20a5f6")
```

---

*Generated by GhostGoat Ordinance System — Central Neural Backend*
*Scan time: 2026-04-30 03:40:11*
