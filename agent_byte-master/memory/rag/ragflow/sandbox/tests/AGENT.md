...
| Field | Value |
|---|---|
| **Folder** | `core/memory/rag/ragflow/sandbox/tests` |
| **Agent ID** | `63629fa1` |
...
- **`sandbox_security_tests_full.py`** — 12.7 KB, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/memory/rag/ragflow/sandbox/tests")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("63629fa1")
```
