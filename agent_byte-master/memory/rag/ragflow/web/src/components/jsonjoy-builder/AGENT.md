# AGENT — `jsonjoy-builder`

> Auto-generated folder agent. **Do not edit manually** — regenerated on every scan.

| Field | Value |
|---|---|
| **Folder** | `core/memory/rag/ragflow/web/src/components/jsonjoy-builder` |
| **Agent ID** | `de0084ec` |
...
- **`index.css`** — 6.6 KB, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/memory/rag/ragflow/web/src/components/jsonjoy-builder")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("de0084ec")
```
