# AGENT - llm-setting-items
**Auto-generated folder agent**
**Last Updated:** 2026-03-06 03:56:29
**Folder Path:** `/home/user/GhostGoat/core/reasoning/brain/rag/ragflow/web/src/components/llm-setting-items`
**Agent ID:** `pending`
...
context = system.backend.get_folder_context('/home/user/GhostGoat/core/reasoning/brain/rag/ragflow/web/src/components/llm-setting-items')
```
