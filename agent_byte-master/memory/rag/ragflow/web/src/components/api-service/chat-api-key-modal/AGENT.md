# AGENT - chat-api-key-modal
**Auto-generated folder agent**
**Last Updated:** 2026-03-06 03:56:28
**Folder Path:** `/home/user/GhostGoat/core/reasoning/brain/rag/ragflow/web/src/components/api-service/chat-api-key-modal`
**Agent ID:** `pending`
...
context = system.backend.get_folder_context('/home/user/GhostGoat/core/reasoning/brain/rag/ragflow/web/src/components/api-service/chat-api-key-modal')
```
