...
**Folder Path:** `/home/user/GhostGoat/core/reasoning/brain/rag/ragflow/web/src/components/list-filter-bar`
**Agent ID:** `pending`
...
context = system.backend.get_folder_context('/home/user/GhostGoat/core/reasoning/brain/rag/ragflow/web/src/components/list-filter-bar')
```
