# AGENT - parse-configuration
**Auto-generated folder agent**
**Last Updated:** 2026-03-06 03:56:30
**Folder Path:** `/home/user/GhostGoat/core/reasoning/brain/rag/ragflow/web/src/components/parse-configuration`
**Agent ID:** `pending`
...
context = system.backend.get_folder_context('/home/user/GhostGoat/core/reasoning/brain/rag/ragflow/web/src/components/parse-configuration')
```
