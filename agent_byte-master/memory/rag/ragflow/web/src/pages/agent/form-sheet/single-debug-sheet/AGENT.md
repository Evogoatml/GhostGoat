# AGENT - single-debug-sheet
**Auto-generated folder agent**
**Last Updated:** 2026-03-06 03:56:31
**Folder Path:** `/home/user/GhostGoat/core/reasoning/brain/rag/ragflow/web/src/pages/agent/form-sheet/single-debug-sheet`
**Agent ID:** `pending`
...
context = system.backend.get_folder_context('/home/user/GhostGoat/core/reasoning/brain/rag/ragflow/web/src/pages/agent/form-sheet/single-debug-sheet')
```
