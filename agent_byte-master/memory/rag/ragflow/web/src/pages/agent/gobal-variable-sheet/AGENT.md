# AGENT - gobal-variable-sheet
**Auto-generated folder agent**
**Last Updated:** 2026-03-06 03:56:33
**Folder Path:** `/home/user/GhostGoat/core/reasoning/brain/rag/ragflow/web/src/pages/agent/gobal-variable-sheet`
**Agent ID:** `pending`
...
- `component/add-variable-modal.tsx`
  - Size: 3.8KB
  - Modified: 2026-03-03
- `hooks/use-form.tsx`
  - Size: 1.3KB
  - Modified: 2026-03-03
- `hooks/use-object-fields.tsx`
  - Size: 9.1KB
  - Modified: 2026-03-03
- `index.tsx`
  - Size: 5.9KB
...
context = system.backend.get_folder_context('/home/user/GhostGoat/core/reasoning/brain/rag/ragflow/web/src/pages/agent/gobal-variable-sheet')
```
