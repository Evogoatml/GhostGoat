...
**Folder Path:** `/home/user/GhostGoat/core/reasoning/brain/rag/ragflow/web/src/pages/chunk/parsed-result`
**Agent ID:** `pending`
...
- `../parsed-result-panel.tsx`
  - Size: 1.2KB
  - Modified: 2026-03-03
- `add-knowledge/components/knowledge-chunk/components/chunk-card/index.tsx`
  - Size: 3.5KB
  - Modified: 2026-03-03
- `add-knowledge/components/knowledge-chunk/components/chunk-creating-modal/index.tsx`
  - Size: 5.9KB
  - Modified: 2026-03-03
- `add-knowledge/components/knowledge-chunk/components/chunk-creating-modal/tag-feature-item.tsx`
  - Size: 4.6KB
  - Modified: 2026-03-03
- `add-knowledge/components/knowledge-chunk/components/chunk-result-bar/checkbox-sets.tsx`
  - Size: 2.7KB
  - Modified: 2026-03-03
- `add-knowledge/components/knowledge-chunk/components/chunk-result-bar/index.tsx`
  - Size: 3.2KB
  - Modified: 2026-03-03
- `add-knowledge/components/knowledge-chunk/components/chunk-toolbar/index.tsx`
  - Size: 5.4KB
  - Modified: 2026-03-03
- `add-knowledge/components/knowledge-chunk/index.tsx`
  - Size: 10.0KB
  - Modified: 2026-03-03
- `add-knowledge/index.tsx`
  - Size: 2.0KB
  - Modified: 2026-03-03
- `index.tsx`
  - Size: 245B
...
context = system.backend.get_folder_context('/home/user/GhostGoat/core/reasoning/brain/rag/ragflow/web/src/pages/chunk/parsed-result')
```
