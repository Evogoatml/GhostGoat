# AGENT - document-preview-modal
**Auto-generated folder agent**
**Last Updated:** 2026-03-06 03:56:35
**Folder Path:** `/home/user/GhostGoat/core/reasoning/brain/rag/ragflow/web/src/pages/next-search/document-preview-modal`
**Agent ID:** `pending`
...
context = system.backend.get_folder_context('/home/user/GhostGoat/core/reasoning/brain/rag/ragflow/web/src/pages/next-search/document-preview-modal')
```
