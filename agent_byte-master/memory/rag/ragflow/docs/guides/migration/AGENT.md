...
| Field | Value |
|---|---|
| **Folder** | `core/memory/rag/ragflow/docs/guides/migration` |
| **Agent ID** | `0cb24556` |
...
- **`migrate_from_docker_compose.md`** — 3.5 KB, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/memory/rag/ragflow/docs/guides/migration")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("0cb24556")
```
