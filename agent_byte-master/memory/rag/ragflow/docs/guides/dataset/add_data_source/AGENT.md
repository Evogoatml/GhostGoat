...
| Field | Value |
|---|---|
| **Folder** | `core/memory/rag/ragflow/docs/guides/dataset/add_data_source` |
| **Agent ID** | `77620be5` |
...
- **`add_google_drive.md`** — 6.5 KB, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/memory/rag/ragflow/docs/guides/dataset/add_data_source")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("77620be5")
```
