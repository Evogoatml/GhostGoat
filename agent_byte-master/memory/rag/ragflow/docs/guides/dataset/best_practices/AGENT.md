...
| Field | Value |
|---|---|
| **Folder** | `core/memory/rag/ragflow/docs/guides/dataset/best_practices` |
| **Agent ID** | `63573aa2` |
| **Last Updated** | `2026-04-30 03:39:48` |
| **Files Tracked** | `1` |
| **Total Size** | `0.2 KB` |
...
- **`_category_.json`** — 160 B, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/memory/rag/ragflow/docs/guides/dataset/best_practices")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("63573aa2")
```

---

*Generated by GhostGoat Ordinance System — Central Neural Backend*
*Scan time: 2026-04-30 03:39:48*
