...
| Field | Value |
|---|---|
| **Folder** | `core/memory/rag/ragflow/rag/flow/splitter` |
| **Agent ID** | `e7771234` |
...
- **`splitter.py`** — 5.5 KB, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/memory/rag/ragflow/rag/flow/splitter")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("e7771234")
```
