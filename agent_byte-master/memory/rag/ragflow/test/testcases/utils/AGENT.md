...
| Field | Value |
|---|---|
| **Folder** | `core/memory/rag/ragflow/test/testcases/utils` |
| **Agent ID** | `cc565854` |
...
- **`file_utils.py`** — 2.8 KB, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/core/memory/rag/ragflow/test/testcases/utils")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("cc565854")
```
