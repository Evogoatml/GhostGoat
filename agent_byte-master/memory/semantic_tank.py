...
class SemanticKnowledgeTank:
    ...
    _DEFAULT_DB = os.path.join(
        _HERE, "..", "reasoning", "brain", "knowledge", "knowledge_tank.db"
    )
    _DEFAULT_EMB = os.path.join(_HERE, "..", "reasoning", "brain", "knowledge", "embeddings.pkl")

    def __init__(self, db_path: str = None, embeddings_path: str = None):
        db_path = db_path or os.path.normpath(self._DEFAULT_DB)
        embeddings_path = embeddings_path or os.path.normpath(self._DEFAULT_EMB)
    ...
    def _init_model(self):
        """Lazy-initialize sentence transformer model (called on first use)."""
