# AGENT — `agent-19b68ab6`

> Auto-generated folder agent. **Do not edit manually** — regenerated on every scan.

| Field | Value |
|---|---|
| **Folder** | `data/agent_byte/agent-19b68ab6/agents/agent-19b68ab6` |
| **Agent ID** | `91e5ea27` |
...
ctx = client.get_folder_context("/home/popic/GhostGoat/data/agent_byte/agent-19b68ab6/agents/agent-19b68ab6")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("91e5ea27")
```
