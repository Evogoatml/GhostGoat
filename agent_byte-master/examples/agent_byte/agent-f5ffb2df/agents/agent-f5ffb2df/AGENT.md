# AGENT — `agent-f5ffb2df`

> Auto-generated folder agent. **Do not edit manually** — regenerated on every scan.

| Field | Value |
|---|---|
| **Folder** | `data/agent_byte/agent-f5ffb2df/agents/agent-f5ffb2df` |
| **Agent ID** | `916e92a7` |
...
- **`profile.json`** — 899 B, modified 2026-04-24
...
ctx = client.get_folder_context("/home/popic/GhostGoat/data/agent_byte/agent-f5ffb2df/agents/agent-f5ffb2df")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("916e92a7")
```
