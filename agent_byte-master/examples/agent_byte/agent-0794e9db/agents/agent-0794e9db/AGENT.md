# AGENT — `agent-0794e9db`

> Auto-generated folder agent. **Do not edit manually** — regenerated on every scan.

| Field | Value |
|---|---|
| **Folder** | `data/agent_byte/agent-0794e9db/agents/agent-0794e9db` |
| **Agent ID** | `af6d535b` |
...
ctx = client.get_folder_context("/home/popic/GhostGoat/data/agent_byte/agent-0794e9db/agents/agent-0794e9db")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("af6d535b")
```
