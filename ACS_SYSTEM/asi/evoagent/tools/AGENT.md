...
| Field | Value |
|---|---|
| **Folder** | `ACS_SYSTEM/asi/evoagent/tools` |
| **Agent ID** | `a05cfbfa` |
| **Last Updated** | `2026-04-30 03:37:49` |
| **Files Tracked** | `2` |
| **Total Size** | `2.8 KB` |
...
- **`registry.py`** — 2.8 KB, modified 2026-04-23
