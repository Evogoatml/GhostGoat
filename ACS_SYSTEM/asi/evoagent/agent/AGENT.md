...
| Field | Value |
|---|---|
| **Folder** | `ACS_SYSTEM/asi/evoagent/agent` |
| **Agent ID** | `8510b800` |
...
- **`main.py`** — 2.1 KB, modified 2026-04-23
- **`planner.py`** — 1.4 KB, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/ACS_SYSTEM/asi/evoagent/agent")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("8510b800")
```
