...
| Field | Value |
|---|---|
| **Folder** | `ACS_SYSTEM/asi/evoagent/configs` |
| **Agent ID** | `cf538768` |
...
- **`default.yaml`** — 302 B, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/ACS_SYSTEM/asi/evoagent/configs")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("cf538768")
```
