...
**Last Updated:** 2026-03-06 03:56:11
**Folder Path:** `/home/user/GhostGoat/ACS_SYSTEM/cipherdsl/out/rust/src`
**Agent ID:** `pending`
...
context = system.backend.get_folder_context('/home/user/GhostGoat/ACS_SYSTEM/cipherdsl/out/rust/src')
```
