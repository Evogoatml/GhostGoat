...
| Field | Value |
|---|---|
| **Folder** | `ACS_SYSTEM/adap_dia_sys/modules/cipherdsl/codegen` |
| **Agent ID** | `83586c86` |
...
- **`go_gen.py`** — 7.1 KB, modified 2026-04-23
- **`rust_gen.py`** — 10.0 KB, modified 2026-04-23
...
ctx = client.get_folder_context("/home/popic/GhostGoat/ACS_SYSTEM/adap_dia_sys/modules/cipherdsl/codegen")

# Full-text search across all folders
results = client.search("your query")

# This agent's neighbours in the knowledge graph
neighbours = client.get_neighbours("83586c86")
```
