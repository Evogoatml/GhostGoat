...
from integrations.unified_integration import UnifiedIntegrationLayer, SystemType, get_integration_layer
from frameworks.monitoring.monitoring import get_monitoring
from frameworks.llm.multi_llm import create_llm
...
if __name__ == "__main__" and FLASK_AVAILABLE:
    ...
    debug = os.getenv("GHOSTGOAT_ENV", "development") != "production"
